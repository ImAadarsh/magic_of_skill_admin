                        ...
                        <ul class="list-group radius-8">
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><iconify-icon icon="ci:bell-notification" class="text-xl"></iconify-icon></span>
                                    Push Notification (This is push notifications)
                                </div>
                            </li>
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><iconify-icon icon="mynaui:cart-check" class="text-xl"></iconify-icon></span>
                                    New Orders confirmed (This is Orders confirmed)
                                </div>
                            </li>
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><iconify-icon icon="mdi:security-lock-outline" class="text-xl"></iconify-icon></span>
                                    Security Access (This is Security Access)
                                </div>
                            </li>
                            <li class="list-group-item border text-secondary-light p-16 bg-base border-bottom-0">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><iconify-icon icon="tabler:folder-open" class="text-xl"></iconify-icon></span>
                                    Storage Folder (This is Storage Folder)
                                </div>
                            </li>
                            <li class="list-group-item border text-secondary-light p-16 bg-base">
                                <div class="d-flex align-items-center gap-2">
                                    <span class="d-flex"><iconify-icon icon="flowbite:forward-outline" class="text-xl"></iconify-icon></span>
