          ...
          <div class="card h-100 p-0">
              ...
              <div class="card-body py-16 px-24 d-flex flex-wrap align-items-center gap-3">
                ...
                <div class="btn-group" role="group" aria-label="Default button group">
                  <button type="button" class="btn btn-light-100 px-20 py-13 radius-8 text-dark d-flex"> <iconify-icon icon="heroicons:bars-3-bottom-left-16-solid" class="text-xl"></iconify-icon></button>
                  <button type="button" class="btn btn-light-100 px-20 py-13 radius-8 text-dark d-flex"> <iconify-icon icon="fe:bar" class="text-xl"></iconify-icon> </button>
                  <button type="button" class="btn btn-light-100 px-20 py-13 radius-8 text-dark d-flex"><iconify-icon icon="heroicons:bars-3-bottom-right-16-solid" class="text-xl"></iconify-icon></button>
                </div>
              </div>
          </div>
      </div>
