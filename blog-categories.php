...
// Build the SQL query
$sql = "SELECT id, name, updated_at, created_at FROM blog_categories";
...
$countSql = "SELECT COUNT(*) FROM blog_categories";
if (!empty($whereClause)) {
...
<head>
    ...
    <title>Blog Categories - Magic Of Skills DashBoard</title>
...
<body>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> 
                                            <div class="d-flex align-items-center gap-10 justify-content-center">
                                                <a href="edit-blog-category.php?id=<?php echo htmlspecialchars($category['id']); ?>" type="button" class="bg-success-focus text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle"> 
    ...
    <script>
        ...
        document.getElementById('downloadExcel').addEventListener('click', function() {
            ...
            var wb = XLSX.utils.table_to_book(table, {sheet: "Blog Categories"});
            XLSX.writeFile(wb, 'blog_categories.xlsx');
        });
