            ...
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body p-24">
                    <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                        ...
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"><iconify-icon icon="ep:d-arrow-left" class="text-xl"></iconify-icon></a>
                        </li>
                        <li class="page-item">
                        ...
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"> <iconify-icon icon="ep:d-arrow-right" class="text-xl"></iconify-icon> </a>
                        </li>
                        <li class="page-item">
            ...
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body p-24">
                    <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                        ...
                        <li class="page-item">
                            <a class="page-link bg-base border text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"><iconify-icon icon="ep:d-arrow-left" class="text-xl"></iconify-icon></a>
                        </li>
                        <li class="page-item">
                        ...
                        <li class="page-item">
                            <a class="page-link bg-base border text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"> <iconify-icon icon="ep:d-arrow-right" class="text-xl"></iconify-icon> </a>
                        </li>
                        <li class="page-item">
            ...
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body p-24">
                    <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                        ...
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"><iconify-icon icon="iconamoon:arrow-left-2-light" class="text-xxl"></iconify-icon></a>
                        </li>
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)">1</a>
                        </li>
                        ...
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"> <iconify-icon icon="iconamoon:arrow-right-2-light" class="text-xxl"></iconify-icon> </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"> <iconify-icon icon="ep:d-arrow-right" class="text-xl"></iconify-icon> </a>
                        </li>
        ...
        <div class="col-md-6">
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body p-24">
                    <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium rounded-circle border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"><iconify-icon icon="ep:d-arrow-left" class="text-xl"></iconify-icon></a>
                        </li>
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium rounded-circle border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"><iconify-icon icon="iconamoon:arrow-left-2-light" class="text-xxl"></iconify-icon></a>
                        </li>
                        <li class="page-item">
                        ...
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium rounded-circle border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"> <iconify-icon icon="iconamoon:arrow-right-2-light" class="text-xxl"></iconify-icon> </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium rounded-circle border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"> <iconify-icon icon="ep:d-arrow-right" class="text-xl"></iconify-icon> </a>
                        </li>
                    </ul>
                    <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center mt-24">
                        <li class="page-item">
                ...
                <div class="card-body p-24 text-center">
                    <div class="p-24 bg-primary-50 d-inline-block radius-12 bg-primary-success-gradient justify-content-center mx-auto">
                        <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                            ...
                            <li class="page-item">
                                <a class="page-link bg-base text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"><iconify-icon icon="ep:d-arrow-left" class="text-xl"></iconify-icon></a>
                            </li>
                            <li class="page-item">
                            ...
                            <li class="page-item">
                                <a class="page-link bg-base text-secondary-light fw-medium radius-8 border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"> <iconify-icon icon="ep:d-arrow-right" class="text-xl"></iconify-icon> </a>
                            </li>
                            <li class="page-item">
            ...
            <div class="card p-0 overflow-hidden position-relative radius-12">
                ...
                <div class="card-body text-center p-24">
                    <ul class="pagination d-flex flex-wrap align-items-center justify-content-center">
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px rounded-pill rounded-end-0" href="javascript:void(0)"><iconify-icon icon="ep:d-arrow-left" class="text-xl"></iconify-icon></a>
                        </li>
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"><iconify-icon icon="iconamoon:arrow-left-2-light" class="text-xxl"></iconify-icon></a>
                        </li>
                        <li class="page-item">
                        ...
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)"> <iconify-icon icon="iconamoon:arrow-right-2-light" class="text-xxl"></iconify-icon> </a>
                        </li>
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px rounded-pill rounded-start-0" href="javascript:void(0)"> <iconify-icon icon="ep:d-arrow-right" class="text-xl"></iconify-icon> </a>
                        </li>
                    </ul>
                    <ul class="pagination d-flex flex-wrap align-items-center justify-content-center mt-24">
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px rounded-pill rounded-end-0" href="javascript:void(0)"><iconify-icon icon="iconamoon:arrow-left-2-light" class="text-xxl"></iconify-icon></a>
                        </li>
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px" href="javascript:void(0)">1</a>
                        </li>
                        ...
                        <li class="page-item">
                            <a class="page-link bg-primary-50 text-secondary-light fw-medium border-0 px-20 py-10 d-flex align-items-center justify-content-center h-48-px w-48-px rounded-pill rounded-start-0" href="javascript:void(0)"> <iconify-icon icon="iconamoon:arrow-right-2-light" class="text-xxl"></iconify-icon></a>
                        </li>
                    </ul>
                </div>  
            </div>
