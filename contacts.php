...
if (isset($_GET['search']) && $_GET['search'] != '') {
    ...
    $whereClause[] = "(name LIKE ? OR email LIKE ? OR mobile LIKE ? OR subject LIKE ?)";
...
<head>
    ...
    <title>Contacts - Magic Of Skills Dashboard</title>
...
<body>
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                <h6 class="fw-semibold mb-0">Contacts Database</h6>
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium">MOS | Contacts</li>
                </ul>
            </div>
                            ...
                            <tbody>
                                <?php foreach ($contacts as $index => $contact): ?>
                                    <tr>
                                        ...
                                        <td><p style="width: 420px; text-align: justify;"><?php echo htmlspecialchars(($contact['query'])); ?></p></td>
                                        <td><?php echo date('d M Y', strtotime($contact['created_at'])); ?></td>
                                        <td class="text-center"> 
                                            <div class="d-flex align-items-center gap-10 justify-content-center">
                                                <button type="button" class="delete-contact bg-danger-focus bg-hover-danger-200 text-danger-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" data-contactid="<?php echo $contact['id']; ?>"> 
    ...
    <script>
        ...
        document.getElementById('downloadExcel').addEventListener('click', function() {
            ...
            var wb = XLSX.utils.table_to_book(table, {sheet: "Contacts"});
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(jqXHR, textStatus, errorThrown) {
                                ...
                                Swal.fire(
                                    'Error!',
                                    'An error occurred while deleting the contact. Please check the console for details.',
                                    'error'
                                );
                            }
                        });
