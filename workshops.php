                    ...
                    <div class="d-flex align-items-center flex-wrap gap-3">
                        ...
                        <div id="filterContainer" class="d-none d-md-block">
                            <form method="GET" class="d-flex align-items-center gap-3 flex-wrap">
                                ...
                                <select name="trainer" class="form-select form-select-sm w-auto ps-12 py-6 radius-12 h-40-px" onchange="this.form.submit()">
                                ...
                                <input type="number" class="bg-base h-40-px w-auto" name="min_price" placeholder="Min Price" value="<?php echo isset($_GET['min_price']) ? htmlspecialchars($_GET['min_price']) : ''; ?>">
                                <input type="number" class="bg-base h-40-px w-auto" name="max_price" placeholder="Max Price" value="<?php echo isset($_GET['max_price']) ? htmlspecialchars($_GET['max_price']) : ''; ?>">
                ...
                <div class="card-body p-24">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <img src="<?php echo isset($workshop['icon']) ? $uri . $workshop['icon'] : "assets/images/mos_icon.png"; ?>" alt="" class="w-40-px h-40-px rounded-circle flex-shrink-0 me-12 overflow-hidden">
                                                <div class="flex-grow-1">
                                                    <span class="text-md mb-0 fw-normal text-secondary-light"><?php echo htmlspecialchars($workshop['name']); ?></span>
                                                </div>
                                            </div>
                                        </td>
                                        <td><?php echo htmlspecialchars($workshop['trainer_name']); ?></td>
                                        <td><?php echo htmlspecialchars($workshop['category_name']); ?></td>
                                        <td><?php echo $workshop['level'] == 1 ? 'Beginner' : ($workshop['level'] == 2 ? 'Intermediate' : 'Advanced'); ?></td>
                                        <td><?php echo $workshop['price'] == 0 ? 'Free' : '₹' . number_format($workshop['price'], 2); ?></td>
                                        ...
                                        <td>
                                            ...
                                            <a href="view-enrolled.php?workshop_id=<?php echo $workshop['id']; ?>" class="btn btn-sm btn-primary ml-2">View</a>
                                        </td>
                                        ...
                                        <td class="text-center"> 
                                            <div class="d-flex align-items-center gap-10 justify-content-center">
                                                <a href="https://magicofskills.com/course-details.php?id=<?php echo htmlspecialchars($workshop['id']); ?>" type="button" class="bg-info-focus bg-hover-info-200 text-info-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle"> 
                                                    <iconify-icon icon="majesticons:eye-line" class="icon text-xl"></iconify-icon>
                                                </a>
                                                <a href="edit-workshop.php?id=<?php echo htmlspecialchars($workshop['id']); ?>" type="button" class="bg-success-focus text-success-600 bg-hover-success-200 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle"> 
                                                    <iconify-icon icon="lucide:edit" class="menu-icon"></iconify-icon>
                                                </a>
                                                <button type="button" class="delete-workshop bg-danger-focus bg-hover-danger-200 text-danger-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" data-workshopid="<?php echo $workshop['id']; ?>"> 
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-24">
                        ...
                        <ul class="pagination d-flex flex-wrap align-items-center gap-2 justify-content-center">
                            <?php if ($page > 1): ?>
                                <li class="page-item">
                                    <a class="page-link bg-neutral-300 text-secondary-light fw-semibold radius-8 border-0 d-flex align-items-center justify-content-center h-32-px w-32-px text-md" href="?page=<?php echo $page - 1; ?>&<?php echo http_build_query(array_merge($_GET, ['page' => $page - 1])); ?>">
                            ...
                            ?>
                                <li class="page-item">
                                    <a class="page-link <?php echo $i == $page ? 'bg-primary-600 text-white' : 'bg-neutral-300 text-secondary-light'; ?> fw-semibold radius-8 border-0 d-flex align-items-center justify-content-center h-32-px w-32-px text-md" href="?page=<?php echo $i; ?>&<?php echo http_build_query(array_merge($_GET, ['page' => $i])); ?>">
                                        <?php echo $i; ?>
                                    </a>
                                </li>
                            <?php endfor; ?>
