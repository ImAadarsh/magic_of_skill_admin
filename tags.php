                    ...
                    <div class="card-body p-24">
                        ...
                        <ul class="tag-list d-flex flex-wrap align-items-center gap-20 mt-20">
                            <li class="text-secondary-light border radius-4 px-8 py-2 text-sm line-height-1 fw-medium d-flex align-items-center gap-1">
                                Label
                                <button class="remove-tag text-lg d-flex justify-content-center align-items-center" type="button"><iconify-icon icon="iconamoon:sign-times-light" class="icon line-height-1"></iconify-icon></button>
                            </li>
                            <li class="text-secondary-light border radius-4 px-8 py-2 text-sm line-height-1 fw-medium d-flex align-items-center gap-1">
                                Label
                                <button class="remove-tag text-lg d-flex justify-content-center align-items-center" type="button"><iconify-icon icon="iconamoon:sign-times-light" class="icon line-height-1"></iconify-icon></button>
