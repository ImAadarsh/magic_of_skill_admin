...
if (isset($_GET['search']) && $_GET['search'] != '') {
    ...
    $whereClause[] = "(name LIKE ? OR review LIKE ?)";
...
$countSql = "SELECT COUNT(*) FROM testimonials";
if (!empty($whereClause)) {
...
<head>
    ...
    <title>Testimonials - Magic Of Skills Dashboard</title>
...
<body>
    ...
    <main class="dashboard-main">
        ...
        <div class="dashboard-main-body">
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
                <h6 class="fw-semibold mb-0">Testimonials Database</h6>
                <ul class="d-flex align-items-center gap-2">
                    ...
                    <li>-</li>
                    <li class="fw-medium">MOS | Testimonials</li>
                </ul>
            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> 
                                            <div class="d-flex align-items-center gap-10 justify-content-center">
                                                <button type="button" class="delete-testimonial bg-danger-focus bg-hover-danger-200 text-danger-600 fw-medium w-40-px h-40-px d-flex justify-content-center align-items-center rounded-circle" data-testimonialid="<?php echo $testimonial['id']; ?>"> 
    ...
    <script>
        ...
        document.getElementById('downloadExcel').addEventListener('click', function() {
            ...
            var wb = XLSX.utils.table_to_book(table, {sheet: "Testimonials"});
            XLSX.writeFile(wb, 'testimonials.xlsx');
        });

        // Testimonial deletion functionality
        $(document).ready(function() {
            $('.delete-testimonial').on('click', function() {
                const testimonialId = $(this).data('testimonialid');
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            ...
                            error: function(jqXHR, textStatus, errorThrown) {
                                ...
                                Swal.fire(
                                    'Error!',
                                    'An error occurred while deleting the testimonial. Please check the console for details.',
                                    'error'
                                );
                            }
                        });
